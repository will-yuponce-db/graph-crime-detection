...
- [ ] **Clarify vocabulary in UI copy**
  - [ ] **Problem**: The app labels 199 rows as “Suspects”, but the underlying Databricks model is “entities” with risk scoring. That reads like 199 named suspects, which feels wrong.
  - [ ] **Fix**: Rename UI labels where appropriate:
    - [ ] “Suspects” → “Ranked Entities” (or “Persons of Interest”) unless explicitly `isSuspect === true`
